...
@media (max-width: 576px) {
  ...
  .table-container tr {
    ...
    width: 200%; /* Asegurar que cada fila ocupe el ancho completo */
  }
  .table-container td {
        ...
        <table class="table" style="background-color: transparent; width: 100%;">
            <tr>
                <td style="padding: 10px; text-align: center; width: 50%;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='informe_ArtVentaTotal.php'">
                        <i class="bi bi-cart"></i><span>Ventas por Artículo</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center; width: 50%;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='informe_ArtVentaDiaria.php'">
                        <i class="bi bi-calendar-day"></i><span>Venta Diaria por Artículo</span>
                    </button>
                </td>
            </tr>
            <tr>
                <td style="padding: 10px; text-align: center; width: 50%;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='informe_ArtVentaMes.php'">
                        <i class="bi bi-calendar-week"></i><span>Venta Mensual por Artículo</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center; width: 50%;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='informe_ArtVentaGeneral.php'">
                        <i class="bi bi-bar-chart"></i><span>Venta General por Artículo</span>
                    </button>
                </td>
            </tr>
        </table>
