        ...
        <table class="table" style="background-color: transparent; width: 100%;">
            <tr>
                <td style="padding: 10px; text-align: center; width: 50%;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='informe_Venta.php?inf=inf'">
                        <i class="bi bi-cart"></i><span>Venta</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center; width: 50%;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='informe_Venta.php?inf=D'">
                        <i class="bi bi-calendar-day"></i><span>Venta Diaria</span>
                    </button>
                </td>
            </tr>
            <tr>
                <td style="padding: 10px; text-align: center; width: 50%;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='informe_Venta.php?inf=Ms'">
                        <i class="bi bi-calendar-week"></i><span>Venta Mensual</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center; width: 50%;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='informe_Venta.php?inf=Gnr'">
                        <i class="bi bi-bar-chart"></i><span>Venta General</span>
                    </button>
                </td>
            </tr>
        </table>
