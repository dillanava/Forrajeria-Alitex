...
.button-wrapper {
    flex: 1 1 calc(33.333% - 20px); /* Ajusta el tamaño y el espacio entre botones */
    min-width: 250px; /* Tamaño mínimo para los botones */
}
.button-wrapper.double {
    flex: 1 1 calc(66.666% - 20px); /* Botones que ocupan el espacio de dos botones */
}
...
@media (max-width: 576px) {
  .table-container {
    ...
    max-height: 70vh; /* Ajustar la altura máxima del contenedor */
        ...
        <table class="table" style="background-color: transparent;">
            <tr>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='app.php'">
                        <i class="bi bi-cart"></i><span>Venta</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='appSuelto.php'">
                        <i class="bi bi-box-seam"></i><span>Venta Suelto</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='cuentaCorriente.php'">
                        <i class="bi bi-person"></i><span>Pagar Cuenta Corriente</span>
                    </button>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='cuentaCorrienteEstadoGeneral.php'">
                        <i class="bi bi-file-earmark-text"></i><span>Estado De Cuenta</span>
                    </button>
                </td>
                <td colspan="2" style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='cuentaCorrienteMovimientos.php'">
                        <i class="bi bi-arrow-repeat"></i><span>Movimiento En Cuenta</span>
                    </button>
                </td>
            </tr>
        </table>
