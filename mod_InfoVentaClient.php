...
/* titulo e imagen */
    ...
    @media (max-width: 992px) {
      .navbar-brand img {
        max-height: 100px; /* Aumenta el tamaño del logo para pantallas más pequeñas */
      }
  ...
  .navbar-brand {
    padding-right: 200px; /* Ajusta el espacio a la derecha del logo */
    display: flex;
    align-items: center; /* Alinea verticalmente el contenido */
  }

  .navbar-brand img {
    margin-right: 1550px; /* Espacio entre el logo y el título */
    max-height: 100px; /* Tamaño máximo del logo */
  }
  ...
  .titulo-completo {
    ...
    font-family: 'Tempus Sans ITC', cursive;
    animation: myAnimation 5s infinite; /* Animación si es necesaria */
  }
}

/* Añadir margen superior para evitar que el contenido sea cubierto por la barra de navegación */
body {
  padding-top: 150px; /* Ajusta según la altura de la barra de navegación */
}
...
.nav-icon {
    margin-right: 15px; /* Ajusta este valor del espacio entre iconos según tus necesidades */
}
...
.nav-icon:hover {
  transform: scale(1.5); /* Aumenta el tamaño del icono al pasar el cursor */
}
...
<script type="text/javascript">
    ...
    <ul class="row justify-content-center list-unstyled button-container">
        <li class="col-12 col-md-6 col-lg-4 mb-2 mb-md-3 button-wrapper">
            <a class="btn btn-custom d-flex flex-column justify-content-center align-items-center" href="informe_ArtVenta.php?inf=inf">
                <i class="bi bi-cart"></i><span>Ventas por Artículo</span>
            </a>
        </li>
        <li class="col-12 col-md-6 col-lg-4 mb-2 mb-md-3 button-wrapper">
            <a class="btn btn-custom d-flex flex-column justify-content-center align-items-center" href="informe_ArtVentaDiaria.php?inf=D">
                <i class="bi bi-people"></i><span>Venta de Artículo Por Cliente</span>
            </a>
        </li>
        <li class="col-12 col-md-6 col-lg-4 mb-2 mb-md-3 button-wrapper">
            <a class="btn btn-custom d-flex flex-column justify-content-center align-items-center" href="informe_ArtVentaMes.php?inf=Ms">
                <i class="bi bi-calendar-week"></i><span>Venta Mensual por Artículo</span>
            </a>
        </li>
        <li class="col-12 col-md-6 col-lg-4 mb-2 mb-md-3 button-wrapper">
            <a class="btn btn-custom d-flex flex-column justify-content-center align-items-center" href="informe_ArtVentaGeneral.php?inf=Gnr">
                <i class="bi bi-bar-chart"></i><span>Venta General de Artículo</span>
            </a>
        </li>
    </ul>
</main>
