                ...
                <tbody>
                    <?php foreach ($productos as $producto) { ?>
                        <tr>
                            ...
                            <td colspan="2">
                                <form action="cambiarPrecio.php" method="post" class="d-flex flex-column flex-md-row align-items-md-center">
                                    <input type="hidden" name="id_producto" value="<?php echo $producto->id_articulo ?>">
                                    <button class="btn btn-success btn-sm ms-md-2">Cambiar Precio</button>
                                </form>
                            </td>
                        </tr>
                    <?php } ?>
