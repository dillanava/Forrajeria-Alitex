        ...
        <table class="table" style="background-color: transparent;">
            <tr>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='productos.php'">
                        <i class="bi bi-list-ul"></i><span>Lista Artículos</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='productoAgregar.php'">
                        <i class="bi bi-plus-circle"></i><span>Nuevos Artículos</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='productosEditar.php'">
                        <i class="bi bi-pencil-square"></i><span>Modificar Artículo</span>
                    </button>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='stockModificar.php'">
                        <i class="bi bi-box-arrow-down"></i><span>Modificar Stock</span>
                    </button>
                </td>
                <td colspan="2" style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='stockCambiarPrecio.php'">
                        <i class="bi bi-currency-exchange"></i><span>Modificar Precio</span>
                    </button>
                </td>
            </tr>
        </table>
