        ...
        <table class="table" style="background-color: transparent;">
            <tr>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='mod_InfoVenta.php'">
                        <i class="bi bi-graph-up"></i><span>Informes de Ventas</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='mod_InfoVentaArt.php'">
                        <i class="bi bi-journal-text"></i><span>Informes Venta de Artículos</span>
                    </button>
                </td>
            </tr>
        </table>
