...
<head>
  ...
  <style>
    ...
    @media (max-width: 576px) {
        ...
        /* Alineación de los íconos y el botón colapsable */
        .navbar-icons,
        .navbar-toggler {
            align-items: center;
        }

        .navbar-links, .search-user {
            display: flex;
...
<section id="segunda-seccion">
        <div class="container position-relative card">
            ...
            <tr>
              ...
              <td scope="col">Precio Inicial</td>
          ...
          <div class="card-body d-flex justify-content-between align-items-center">
            ...
            <form method="post" action="ventaPreparacion.php">
                <input type="hidden" name="suelto" value="1">
                <input type="button" value="Realizar Venta" class="btn btn-success btn-sm">
