        ...
        <table class="table" style="background-color: transparent;">
            <tr>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='clienteCargar.php'">
                        <i class="bi bi-person-plus"></i><span>Nuevo Cliente</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='clienteModificar.php'">
                        <i class="bi bi-pencil-square"></i><span>Modificar Cliente</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='estadoCliente.php'">
                        <i class="bi bi-info-circle"></i><span>Estado del Cliente</span>
                    </button>
                </td>
            </tr>
        </table>
