...
<section class="contenido wrapper " id="primera-seccion">
  ...
  <div class="card-header">
          <h3>Buscar Articulo Para Vender Suelto</h3>
         <?php //appButton() ?>
    ...
    <table class="table table-striped table-hover">
      ...
      <tbody>
      <form action="sueltoAbrirBolsa.php" method="post"> 
      ...
      { ?>
        <tr>
          ...
          <td><script type="text/javascript">
                ...
                {
                    var mensaje;
                    var opcion = confirm("Desea Abrir Este Articulo");
                    if (opcion == true) {
                        mensaje = i;
                    } else {
                        mensaje = "-1";
                ...
                <button class="btn btn-success btn-sm" onclick="vT(<?php echo $producto->id_articulo; ?>)">
                    Abrir Bolsa
                </button>    
