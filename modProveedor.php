        ...
        <table class="table" style="background-color: transparent;">
            <tr>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='proveedorCargar.php'">
                        <i class="bi bi-person-plus"></i><span>Nuevo Proveedor</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='proveedorModificar.php'">
                        <i class="bi bi-pencil-square"></i><span>Modificar Proveedor</span>
                    </button>
                </td>
            </tr>
        </table>
