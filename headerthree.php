        ...
        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#eliminarUsuarioModal">Eliminar Usuario</button>
            ...
            <div class="collapse navbar-collapse" id="navbarLinks">
                <div class="navbar-links">
                    <a href="informe_ArtVentaTotal.php">Ventas por Articulo</a>
                    <a href="informe_ArtVentaDiaria.php" >Venta Diaria por Articulo</a>
                    <a href="informe_ArtVentaMes.php" >Venta Mensual por Articulo</a>
                    <a href="informe_ArtVentaGeneral.php" >Venta Articulo General</a>
