...
@media (max-width: 576px) {
  .table-container {
    ...
    max-height: 65vh; /* Ajustar la altura máxima del contenedor */
...
<div class="navbar-icons">
  <a href="modulos.php" class="nav-icon" onclick="event.preventDefault();">
    <i class="bi bi-house"></i>
  </a>
  <a href="app.php" class="nav-icon" onclick="event.preventDefault();">
...
<div class="collapse navbar-collapse" id="navbarContent">
    ...
    <li>
        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#buscarUsuarioModal">Buscar Empleados</button>
    </li>
    <li>
        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#eliminarUsuarioModal">Eliminar Empleados</button>
    </li>
</ul>
...
<div class="modal fade" id="buscarUsuarioModal" tabindex="-1" aria-labelledby="buscarUsuarioModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="buscarUsuarioModalLabel">Buscador de Empleados</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="buscarUsuarioForm" onsubmit="return buscarUsuario();">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
            <button type="submit" class="btn btn-primary">Buscar Empleados</button>
          </div>
        </form>
        ...
        <table class="table" style="background-color: transparent;">
            <tr>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='modventas.php'">
                        <i class="bi bi-cart"></i><span>Ventas</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='modArticulos.php'">
                        <i class="bi bi-box-seam"></i><span>Artículos</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='modCliente.php'">
                        <i class="bi bi-person"></i><span>Cliente</span>
                    </button>
                </td>
            </tr>
            <tr>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='modProveedor.php'">
                        <i class="bi bi-truck"></i><span>Proveedor</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='modCategoria.php'">
                        <i class="bi bi-tags"></i><span>Categoría</span>
                    </button>
                </td>
                <td style="padding: 10px; text-align: center;">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='modInformes.php'">
                        <i class="bi bi-graph-up"></i><span>Informes</span>
                    </button>
                </td>
            </tr>
            <tr>
                <td style="padding: 10px; text-align: center;" colspan="3">
                    <button class="btn btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='pedido.php'">
                        <i class="bi bi-journal"></i><span>Pedido</span>
                    </button>
                </td>
            </tr>
        </table>
