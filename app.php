...
if (!isset($_SESSION["idUsuario"])) {
  ...
  exit("Primero debe ingresar al sistema el usuario en turno que va a atender<br><a href='index.php'>Regresar al inicio de sesion</a>");
} 
...
@media (max-width: 576px) {
  .table-container {
    ...
    max-height: 80vh; /* Ajustar la altura máxima del contenedor */
...
.navbar-icons .nav-icon {
  ...
  .navbar-collapse {
    ...
    /* Estilo para los vínculos adicionales */
    .navbar-links {
        display: flex;
    ...
    .navbar-links a:hover {
        ...
        color: #0d6efd; /* Cambia a color azul */
        text-decoration: none; /* Quita el subrayado */
    }

    /* Estilo para los vínculos adicionales en la versión de escritorio */
    @media (min-width: 992px) {
        .navbar-links {
            flex-direction: row;
            margin-top: 10px; /* Añade un margen superior para separar los vínculos del contenido superior */
            justify-content: center;
            width: 100%;
            text-align: center;
        }
        .navbar-links a {
            margin: 0 15px; /* Margen horizontal para los vínculos en la versión de escritorio */
        }
        ...
        .search-user {
            ...
            width: auto;
            margin-top: 0; /* Remove top margin for desktop view */
        }

        .search-user form {
            margin-bottom: 0; /* Remove bottom margin for desktop view */
        }
    }
</style>
</head>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center">
          ...
                    </div>
                ...
                <!-- Formulario de búsqueda y usuario en la versión de escritorio -->
                <div class="search-user d-none d-lg-flex">
                    <!-- Formulario de búsqueda -->
                    <form class="d-flex align-items-center" role="search" action="app.php" method="POST">
                    ...
                    <?php
                        ...
                        foreach ($us as $u) {
                            ...
                            <div class="dropdown me-3 order-2">
                                <button class="btn btn-secondary dropdown-toggle w-auto" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                    ' . $u->usuario . '
                                </button>
    ...
    <li>
        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#eliminarUsuarioModal">Eliminar Usuario</button>
            ...
            <!-- Vínculos adicionales debajo del título -->
            <div class="collapse navbar-collapse" id="navbarLinks">
                <div class="navbar-links">
                    <a href="ProductoAgregar.php">Agregar Producto</a>
                    <a href="clienteCargar.php">Agregar Cliente</a>
                    <a href="app.php">Lista General</a>
                    <a href="appSuelto.php">Lista De Sueltos</a>
                    <a href="#primera-seccion">Lista De Articulos</a>
                    <a href="#segunda-seccion">Articulos Seleccionados</a>
                </div>
                <!-- Formulario de búsqueda y usuario en el menú colapsable para versión móvil -->
                <div class="d-flex flex-column align-items-center w-100 mt-3 d-lg-none">
                    <!-- Formulario de búsqueda -->
                    <form class="d-flex mb-3 w-100" role="search" action="app.php" method="POST">
                        <input class="form-control me-2 flex-grow-1" name="buscar" type="search" placeholder="Buscar" aria-label="Search">
                    </form>
                    <!-- Usuario -->
                    <?php
                        ...
                        foreach ($us as $u) {
                            echo '
                            <div class="dropdown mb-3 w-100 text-center">
  ...
  <section class="contenido wrapper" id="primera-seccion">
        <div class="container position-relative card">
            <div class="card-header">
                <h3>Venta - Seleccionar Artículos</h3>
                    ...
                    <tbody>
                        ...
                        foreach ($productos as $producto) { ?>
                            <tr>
                                ...
                                <td style="<?php echo ($producto->suelto == 1) ? 'color:blue' : ''; ?>">
                                    <?php echo ($producto->suelto == 1) ? "<b>Suelto(" . $producto->id_unidadVenta . ")</b>" : $producto->id_unidadVenta; ?>
                                </td>
                                ...
                                if ($sta) { ?>
                                    <td>
                                        <form action="carritoEliminar.php" method="post">
                                            ...
                                            <span class="btn btn-info btn-sm redirect-to-section">
                                ...
                                <?php
                                    ...
                                    <form action="carritoAgregar.php" method="post">
                                        ...
                                        <td>
                                            <input type="hidden" name="id_producto" value="<?php echo $producto->id_articulo ?>">
                                            <button class="btn btn-success btn-sm" onclick="agregarAlCarrito(<?php echo htmlspecialchars($producto->id_articulo); ?>)">
                                                Agregar
                                            </button>
                                        </td>
                                    </form>
                        ...
                        <script>
                            document.addEventListener("DOMContentLoaded", function() {
                                var buttons = document.querySelectorAll('.redirect-to-section');
                                buttons.forEach(function(button) {
                                    button.addEventListener('click', function() {
                                        window.location.href = '#articulos-seleccionados';
                                    });
                                });
                            });

                            function agregarAlCarrito(idProducto) {
                                var stockCell = document.querySelector(`#stock-${idProducto}`);
                                if (stockCell && stockCell.style.color === 'red') {
                                    alert('No se puede agregar al carrito porque no hay suficientes en el stock.');
                                    return false;
                                }
                                return true;
                            }
    ...
    <section id="segunda-seccion">
        <div class="container position-relative card">
            <div class="card-header" id="articulos-seleccionados">
